...
resource "openstack_networking_secgroup_rule_v2" "api_lb_prometheus" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "tcp"
...
resource "openstack_networking_secgroup_rule_v2" "api_lb_http_k8s" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "tcp"
...
resource "openstack_networking_secgroup_rule_v2" "api_lb_https_k8s" {
  direction = "ingress"
  ethertype = "IPv4"
  protocol  = "tcp"
